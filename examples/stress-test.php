...
while ($iter < $limit) {				// большой цикл нагрузки


	while($iter_small<1000){ 			// малый цикл нагрузки, чтобы реже писать в файл
...
$iter +=$iter_small;
$iter_small = 0;
file_put_contents('./out.txt', " Пройдено $iter итераций");
}

$y->save('./out.xml');
echo " Пройдено $iter итераций";
?>
